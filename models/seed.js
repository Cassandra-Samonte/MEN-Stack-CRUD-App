const albums = [
    {
        ...
        description: "2814 is the collaborative project of original music by the artists HKE and t e l e p a t h. The duo first formed in the early days of Dream Catalogue, dropping the self-titled debut album before going on to find success with this follow up album. This was the second album of collaborative duo of HKE and Telepath, working under the name '2814'. A follow up to a relatively minor hit - the self titled debut '2814', 'Birth Of A New Day' ended up becoming a radiant realization of the original project's intention, as both artists expertly mixed and matched ambient palettes and styles to create the vague and distant neon utopia - a sense of romantic melancholy and longing peppered by the suggestive sounds of the world the music inhabited. An album that shaped an era, 'Birth Of A New Day' was quite literal in a prescient manner as it shook the foundations of the underground and catalyzed the 'dreampunk' movement coming out of the post-vaporwave era - helping define the aesthetic of Dream Catalogue as a record label in the process.",
        },
    {
        artist: "ESPRIT 空想",
        ...
        },
    {
        ...
        whereToListen: "https://purelifetapes.bandcamp.com/track/aria-2",
...
const reviews = [
    {
        name: "MinatoArisato",
        album: "Birth Of A New Day",
        title: "Beautiful in every sense of the word.",
        ...
        },
     {
        ...
        album: "200% Electronica",
        title: "This album ranks high on my top of all time.",
        ...
        },
    {
        name: "Modrigue",
        album: "Digital - Dance",
        title: "Uneven but still enjoyable album from SOFTWARE",
        ...
        },
    {
        name: "blender715",
        album: "新世界の弟子たち",
        title: "Floating endlessly above a poorly rendered mid-2000s CGI landscape",
        ...
        },
    {
        name: "roomba33",
        album: "Floral Shoppe",
        title: "A time capsule of vaporwave history",
        ...
        },
     {
        name: "bedroomAOR",
        album: "Class of '84",
        title: "A hall-of-fame sitter if there even was one.",
        ...
        },
    {
        name: "ST4T1C",
        album: "Mana Pool",
        title: "smooth and buttery beats",
        ...
        },
    {
        name: "duncanreviews",
        album: "슈 퍼 마 켓 YES! WE'RE OPEN",
        title: "Doorbell chimes bouncing off windowless walls",
        ...
        },
    {
        name: "psychedelicj",
        album: "Deep Fantasy",
        title: "Chillwave and vaporwave meld into a hazy pop masterpiece.",
        ...
        },
     {
        ...
        album: "virtua.zip",
        title: "This album is admittedly pretty unique.",
        ...
        },
    {
        name: "beefant",
        album: "Late Night Delight",
        title: "It turns out that Late Night Delight was the pleasure I needed to indulge in this Tuesday morning",
        ...
        },
    {
        name: "loruxz25",
        album: "High Fashion Mood Music",
        title: "This is an album full of stock music played 100% straight, and I love it.",
        ...
        },
    {
        name: "rubyfire77",
        album: "Zeldawave 2",
        title: "Zeldawave II moreso plays with the bittersweetness of Majora's Mask",
        ...
        },
     {
        name: "myxogastrid",
        album: "World Class",
        title: "feels like sipping complimentary champagne on a first-class flight to las vegas",
        ...
        },
    {
        ...
        album: "Palm Mall",
        title: "Palm Mall is a masterpiece of not just vaporwave or mallsoft, but even just ambient music in general.",
